...
image::architecture-step3.png[alt='Scenario 3 - Engaging with Partners: Securing API access - North South or External traffic'] 
...
TBC:
The WASM plugin makes it easy to ..... ... ... 
