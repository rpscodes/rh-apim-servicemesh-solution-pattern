...
(b) securely exposes  services to external clients or other Business Unit within the same enterprise (also called _North-South_ or Inter Domain)
...
(b) enables the standardization across the service interactions  (also called _East-West_ or Intra domain)
